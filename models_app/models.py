...
class Profile(models.Model):
    ...
    prfoile_image = models.ImageField(upload_to="profile", null=True, blank=True)
...
class Genre(models.Model):
    ...
    list_of_name = models.CharField(max_length=255, null=True, blank=True)
    books = models.ManyToManyField(Book, related_name='genres')
    is_genre_book= models.BooleanField(default=False)
